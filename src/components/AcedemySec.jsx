                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2" ref={containerRef}>
                    ...
                    <AnimatedBorder>
                        <div className="acedemy-box">
                            ...
                            <div className="text">
                                <p><strong className='font-bold'>Trading View</strong> sit amet consectetur. Orci sed turpis at lectus ut cursus morbi lectus. Vitae nibh aliquam at nec. Arcu.</p>
                            </div>
                        </div>
                    </AnimatedBorder>
                </div>
